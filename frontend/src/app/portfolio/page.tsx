          ...
          <div className="space-y-4">
            <h2 className="text-lg font-semibold text-white">
              ...
              {holdings.data && holdings.data.length > 0 && (
                <span className="text-zinc-500 font-normal text-sm ml-2">({holdings.data.length})</span>
              )}
            </h2>
          ...
          <div className="space-y-4">
            <h2 className="text-lg font-semibold text-white">
              ...
              {watchlist.data && watchlist.data.length > 0 && (
                <span className="text-zinc-500 font-normal text-sm ml-2">({watchlist.data.length})</span>
              )}
            </h2>
